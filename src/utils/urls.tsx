...
export const NATIONALITY_URL = (nationality: string): string | undefined => {
  return  process.env.REACT_APP_ARTISTS_NATIONALITY_URL ? `${process.env.REACT_APP_ARTISTS_NATIONALITY_URL}/${nationality}?&gender=female` : undefined;
};

export const BORN_AFTER_URL = (year: string): string | undefined => {
  return  process.env.REACT_APP_ARTISTS_BORNAFTER_URL ? `${process.env.REACT_APP_ARTISTS_BORNAFTER_URL}/${year}?&gender=female` : undefined;
};
